...
// Prepara uma instrução SQL para inserir os dados na tabela 'usage'
$sql = "INSERT INTO usage (description, volume, latitude, longitude) VALUES ('$description', '$volume', '$latitude', '$longitude')";
